import { ImgHTMLAttributes, ReactElement, forwardRef } from "react";

import { cn } from "@app/helpers";

import { IComponentBaseProps } from "../types";

export type MaskProps = ImgHTMLAttributes<HTMLImageElement> &
    IComponentBaseProps & {
        variant?:
            | "squircle"
            | "heart"
...
export const maskClassesFn = ({ className, variant }: Pick<MaskProps, "className" | "variant"> = {}) =>
    cn("mask", className, {
...
const Mask = forwardRef<HTMLImageElement, MaskProps>(
    ({ src, variant, dataTheme, className, ...props }, ref): ReactElement => {
        return (
            <img
                alt="Mask image"
                {...props}
